...
//   console.log(p);
//   let q =
//     'SHE said "nelly, never give up UNTIL you have TRIED and it\'s TIME to give up!"';
//   console.log(q);
...
//   let sentence = `Hello my name is ${myIntro.fullName()}. I am ${
//     myIntro.age
//   } years old and I was born ${myIntro.dob}. I am ${
//     myIntro.nationality
//   } and my favourite food is ${myIntro.favFood}.`;
...
//   let drinks = ["cola", "fanta", "water", "wine", "milkshake"];

//   console.log(drinks.splice(1, 2, "burger", "chips", "fish"));

//   console.log(drinks.valueOf());

//   console.log(drinks.pop());

//   console.log(drinks.push("juice"));

//   console.log(drinks.shift());

//   console.log(drinks.unshift("lemonade"));
...
//   let numberList = [14, 5476576547244, 344, 40, 563656];

//   let ascNums = numberList.sort(function (a, b) {
//     return a - b;
//   });
...
//   let getTogether = drinks.concat(numberList);
//   console.log(getTogether);

//   /****************************************************************************************************/

//   let whatsTheAnswer = 401 > 10 ? "yes it is" : "no it isn't";
//   console.log(whatsTheAnswer);
...
//       continue;
//     }
//     console.log(`this is the food/drink: ${drinks[i]}.`);
//   }

//   /****************************************************************************************************/

  // let animalSentence = "this is an animal sentence!";
  // let animalWord = animalSentence.search(/animal/i);
  // console.log(animalWord);

  // let animalWord2 = /this/g;
  // console.log(animalWord2.test(animalSentence));
